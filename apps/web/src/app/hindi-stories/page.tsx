...
const faqs = [
  ...
  },
  {
    ...
    a: "English stories are available on all plans including the free plan (250 welcome credits). Hindi narration is available on the Magic Pass plan (₹199/month), which includes 1,000 credits per month, Hindi voice narration, and illustrated scenes.",
  },
  {
        ...
        <section style={{ background: "#fff", padding: "56px 0" }}>
          <div className="mx-auto px-5" style={{ maxWidth: 680 }}>
            ...
            <div className="flex flex-col gap-5">
              {[
                { n: "1", head: "Sign up free", body: "No credit card. 250 welcome credits are waiting for you." },
