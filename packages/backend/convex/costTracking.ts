...
function computeCostUSD(
  ...
  // Challenge questions are generated by the same gemini-2.5-pro text model
  // as the story itself, so they're billed at the same text rates.
  const challengeText =
    ((usage.challengeTextInputTokens ?? 0) / 1_000_000) * rates.textInputPerMillion +
    ((usage.challengeTextOutputTokens ?? 0) / 1_000_000) * rates.textOutputPerMillion;
