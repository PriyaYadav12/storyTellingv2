...
const faqItems = [
  {
    q: "What are credits?",
    a: "Credits are the currency for generating stories. A short story (text + illustrations + voice narration) costs 80 credits, medium costs 100, and long costs 150. New accounts start with 200 free credits — enough for 2 short stories to try.",
  },
  {
    q: "Is there really a free plan?",
    a: "Absolutely. Sign up with your email and get 200 credits instantly — no credit card needed. That's 2 fully illustrated and narrated stories to explore before you decide.",
  },
  {
